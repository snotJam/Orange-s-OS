...
;#######################################################################
;这个程序是在pmtest9a上修改的，实现了一个中断：
;流程：
;	1：除了前面提到的IDT，8295A初始化，这里还调用了int指令调用中断int 080h（267行）
;	2：在IDT的声明中，把080h单独声明出来，它指向SelectorCode32:UserIntHandler中断门
;	3：UserIntHandler中断门代码将在屏幕显示“I”，然后返回程序
;
;
;
;
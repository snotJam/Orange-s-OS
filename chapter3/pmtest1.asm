...
GdtLen	equ	$-LABEL_GDT		;GDT长度，equ也就是equal，有相等的意思，可以看作赋值操作
...
LABEL_BEGIN:
	...
	mov word [LABEL_DESC_CODE32+2],ax		;word，一个字，也就是2个字节，16位
	mov eax,16
	mov byte [LABEL_DESC_CODE32+4],al		;byte，一个字节，8位
